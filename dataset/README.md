...
- **Total Data Size**: ~110 MB
- **Contents**: Ball-by-ball match data, including batter runs, bowler wickets, extras, match venues, overs, dismissal types, and player phase stats.
